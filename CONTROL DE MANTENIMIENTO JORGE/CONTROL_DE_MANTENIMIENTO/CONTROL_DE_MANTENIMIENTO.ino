      ...
      while (client.connected())
      {
        if (client.available())
        {
          ...
          if (c == '\n' && currentLineIsBlank)
          {
            ...
            else if (HTTP_req.indexOf("/V") > 0 || HTTP_req.indexOf("/D") > 0)
            {
              if (SD.begin(4))
              {
                if (SD.exists("DataUser/Userdata.csv"))
                {
                  ...
                  if (myFile)
                  {
                    if (HTTP_req.indexOf("/V") > 0)
                    {
                      ...
                      datosUsers = "";
                      valor = "";
                      valor = mostrarTabla(myFile, sizeFile);
                  ...
                  else
                  {
                    ...
                    datosUsers = "Error abirendo el archivo";
                  }
                  myFile.close();
                }
                else
                {
                  ...
                  datosUsers = "Fichero o archivo que se intenta abrir no existe";
                }
              }
              else
              {
                Serial.println("Error al iniciar SD");
                datosUsers = "Error al iniciar SD";
              }
            }
